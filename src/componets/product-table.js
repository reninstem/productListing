                ...
                {Data.products.map((product, index) => (
                    <div key={index} className="product-container">
                        ...
                        <div className="tags-container">
                            {product.tags?.map((tag, indexTag) => (
                                <span key={indexTag} className={`tag-span ${ tag === "SALE! 13%" ? "orange-bg" : null}`}>{tag}</span>
                            ))}
                        </div>
                        <span className="brand-span">BRAND: {product.brand}</span>
